...
raw=list(json.loads(Path('outputs/ciphertext.json').read_text()).values());a,b=raw[:2];out=[]
...
Path('outputs/relative_cycle_earliest.json').write_text(json.dumps(out,indent=2)+'\n',encoding='utf-8',newline='\r\n')
