...
| --- | --- | --- |
| [Chesewip](Chesewip/) | [Research index](Chesewip/outputs/README.md) | Unknown output substitutions tested: all five values are required in each input coordinate under the stated shared fractionation schedule. Independent certificates and generated controls included; scattered small codebooks remain open. Cipher unsolved. |
...
- [Latest unknown output-map coordinate test](Chesewip/outputs/unknown-map-coordinate-findings.md)
